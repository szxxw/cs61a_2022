def convert_link(link):
    ...
    """
    "*** YOUR CODE HERE ***"
    # # recursive solution for a shallow link
    # if link is Link.empty:
    #     return []
    # return [link.first] + convert_link(link.rest)

    # recursive solution for more than a shallow link
    if link is Link.empty:
        return []
...
def prune_small(t, n):
    ...
    while len(t.branches) > n:
        ...
        t.branches.remove(largest) # remove value from a list
    for b in t.branches:
        prune_small(b, n)
